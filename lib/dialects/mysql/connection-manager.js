...
ConnectionManager.prototype.connect = function(config) {
  ...
  return new Promise(function (resolve, reject) {
    ...
    connection.connect(function(err) {
      ...
      if(self.sequelize.options.afterConnectionQuery !== null){
        connection.query(self.sequelize.options.afterConnectionQuery, null, function(err,results){
          if(err){
            console.log('Error running afterConnectionQuery',err);
            reject(err);
          }
          else{
            resolve(connection);
